...
export default function App() {
  ...
  const TeacherHome = () => {
    ...
    // FIX: useRef lets us trigger the hidden file input from a plain button,
    // which works reliably across all browser/iframe environments.
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-6">
          ...
          <div className="flex flex-wrap items-end gap-5 border-t border-gray-100 pt-5">
            ...
            <div className="flex flex-col">
              ...
              {/* Hidden input triggered via ref — reliable in all environments */}
              <input
                ref={fileInputRef}
                type="file"
                accept=".csv, .xlsx, .xls"
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold transition-colors cursor-pointer text-sm shadow-sm"
              >
